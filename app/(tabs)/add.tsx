        ...
        <View className="mb-5">
          ...
          <View className="flex-row gap-4">
            ...
            >
              ...
              <ThemedText
                className={`text-base ${selectedPerson === '丈夫' ? 'text-blue-600 font-bold' : 'text-gray-800'}`}
              >
                丈夫
              </ThemedText>
            </TouchableOpacity>
            ...
            >
              <ThemedText className="text-lg mr-2">👩</ThemedText>
              <ThemedText
                className={`text-base ${selectedPerson === '妻子' ? 'text-blue-600 font-bold' : 'text-gray-800'}`}
              >
                妻子
              </ThemedText>
            </TouchableOpacity>
